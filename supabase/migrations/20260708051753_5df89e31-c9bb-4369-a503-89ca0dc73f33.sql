DROP FUNCTION IF EXISTS public.checkout_visit(uuid, boolean, boolean, text);
...
REVOKE ALL ON FUNCTION public.checkout_visit(uuid, uuid, boolean, boolean, text) FROM PUBLIC, anon, authenticated;
